...
void myproject_float(
    ...
    input_1_t input_1_ap[N_INPUT_1_1];
    nnet::convert_data<float, input_1_t, N_INPUT_1_1>(input_1, input_1_ap);

    result_t layer20_out_ap[N_LAYER_18];

    myproject(input_1_ap,layer20_out_ap);
...
void myproject_double(
    ...
    input_1_t input_1_ap[N_INPUT_1_1];
    nnet::convert_data<double, input_1_t, N_INPUT_1_1>(input_1, input_1_ap);
