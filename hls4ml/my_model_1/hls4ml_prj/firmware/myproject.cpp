...
void myproject(
    ...
    if (!loaded_weights) {
        ...
        nnet::load_weights_from_txt<model_default_t, 48>(w2, "w2.txt");
        ...
        nnet::load_weights_from_txt<model_default_t, 32>(w14, "w14.txt");
    ...
    nnet::sigmoid<layer14_t, result_t, sigmoid_config16>(layer14_out, layer16_out); // sigmoid
