...
void myproject(
    ...
    #pragma HLS INTERFACE axis port=input_4,layer25_out 
    #pragma HLS DATAFLOW
    ...
    nnet::conv_2d_cl<input_t, fused_convbn_0_result_t, config2>(input_4, layer2_out, w2, b2); // fused_convbn_0
    ...
    nnet::conv_2d_cl<layer5_t, fused_convbn_1_result_t, config6>(layer5_out, layer6_out, w6, b6); // fused_convbn_1
    ...
    hls::stream<fused_convbn_2_result_t> layer10_out("layer10_out");
    #pragma HLS STREAM variable=layer10_out depth=16
    nnet::conv_2d_cl<layer9_t, fused_convbn_2_result_t, config10>(layer9_out, layer10_out, w10, b10); // fused_convbn_2

    hls::stream<layer12_t> layer12_out("layer12_out");
    #pragma HLS STREAM variable=layer12_out depth=16
    nnet::relu<fused_convbn_2_result_t, layer12_t, relu_config12>(layer10_out, layer12_out); // conv_act_2
    ...
    hls::stream<dense_0_result_t> layer15_out("layer15_out");
    #pragma HLS STREAM variable=layer15_out depth=1
    nnet::dense<layer13_t, dense_0_result_t, config15>(layer14_out, layer15_out, w15, b15); // dense_0

    hls::stream<bn_dense_0_result_t> layer17_out("layer17_out");
    #pragma HLS STREAM variable=layer17_out depth=1
    nnet::normalize<dense_0_result_t, bn_dense_0_result_t, config17>(layer15_out, layer17_out, s17, b17); // bn_dense_0

    hls::stream<layer18_t> layer18_out("layer18_out");
    #pragma HLS STREAM variable=layer18_out depth=1
    nnet::relu<bn_dense_0_result_t, layer18_t, relu_config18>(layer17_out, layer18_out); // dense_act_0

    hls::stream<dense_1_result_t> layer19_out("layer19_out");
    #pragma HLS STREAM variable=layer19_out depth=1
    nnet::dense<layer18_t, dense_1_result_t, config19>(layer18_out, layer19_out, w19, b19); // dense_1

    hls::stream<bn_dense_1_result_t> layer21_out("layer21_out");
    #pragma HLS STREAM variable=layer21_out depth=1
    nnet::normalize<dense_1_result_t, bn_dense_1_result_t, config21>(layer19_out, layer21_out, s21, b21); // bn_dense_1

    hls::stream<layer22_t> layer22_out("layer22_out");
    #pragma HLS STREAM variable=layer22_out depth=1
    nnet::relu<bn_dense_1_result_t, layer22_t, relu_config22>(layer21_out, layer22_out); // dense_act_1

    hls::stream<output_dense_result_t> layer23_out("layer23_out");
    #pragma HLS STREAM variable=layer23_out depth=1
    nnet::dense<layer22_t, output_dense_result_t, config23>(layer22_out, layer23_out, w23, b23); // output_dense

    nnet::softmax<output_dense_result_t, result_t, softmax_config25>(layer23_out, layer25_out); // output_softmax
